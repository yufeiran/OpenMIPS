...
#
# Generated by export_simulation on Tue Jul 14 21:45:34 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './openmips_min_sopc_tb.sh' script.

./openmips_min_sopc_tb.sh -reset_run
...
./openmips_min_sopc_tb.sh -noclean_files

For more information on the script, please type './openmips_min_sopc_tb.sh -help'.
